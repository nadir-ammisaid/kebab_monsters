...
- Visualisation des détails (note, adresse, etc.)
- Ajout en favoris pour retrouver ses spots préférés

🛠️ Stack technique : React, TypeScript, Node.js, API REST, API Yelp
...
**Kebab Monsters** is a responsive web app built in 48 hours during a hackathon. It helps users locate the best kebab spots nearby using the Yelp API.

Key features:
- Search kebab places by city or location
- Display results on an interactive map
- View detailed info (rating, address, etc.)
- Add favorites to save preferred locations

🛠️ Tech stack: React, TypeScript, Node.js, REST APIs, Yelp API
